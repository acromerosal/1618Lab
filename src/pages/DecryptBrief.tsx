        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="text-center lg:text-left flex flex-col items-center lg:items-start">
              <h1 className="text-5xl md:text-6xl font-bold uppercase mb-2 text-white tracking-tighter">
                DECRYPT
                <span className="block text-gold">BRIEF</span>
              </h1>
              <p className="font-mono text-xs text-gray-400 leading-relaxed max-w-md lg:max-w-none">
                <HackerText text="ESTABLECIENDO CANAL SEGURO... ENCRIPTACIÓN DE PUNTO A PUNTO ACTIVA. INICIE TRANSMISIÓN DE DATOS." speed={30} />
              </p>
            </div>
            ...
            <div className="hidden lg:block p-6 border border-gold/20 bg-gold/5 rounded-lg">
              <h3 className="text-gold font-bold uppercase text-sm mb-2 flex items-center gap-2">
                <AlertTriangle size={16} /> Protocolo de Silencio
              </h3>
              <p className="text-gray-400 text-xs leading-relaxed">
                Al iniciar esta transmisión, aceptas el pacto de confidencialidad de 1618 LAB. Tus datos serán encriptados y analizados por nuestra IA central. Solo las anomalías dignas de atención recibirán respuesta.
              </p>
            </div>
          </div>
                 ...
                 <form onSubmit={handleSubmit} className="space-y-8 font-mono relative z-30">
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                     <div className="space-y-2 group">
                       <label className={`text-xs uppercase tracking-widest flex items-center gap-2 transition-colors ${activeField === 'name' ? 'text-gold' : 'text-gray-500'}`}>
                         <Terminal size={12} /> IDENTITY_CORE / Nombre
                       </label>
                     ...
                     <div className="space-y-2 group">
                       <label className={`text-xs uppercase tracking-widest flex items-center gap-2 transition-colors ${activeField === 'email' ? 'text-gold' : 'text-gray-500'}`}>
                         <Hash size={12} /> SIGNAL_FREQUENCY / Email
                       </label>
                       <div className="relative">
                         <input 
                           type="email" 
                   ...
                   <div className="space-y-2 group">
                     <label className={`text-xs uppercase tracking-widest flex items-center gap-2 transition-colors ${activeField === 'message' ? 'text-gold' : 'text-gray-500'}`}>
                       <Activity size={12} /> TRANSMISSION_DATA / Mensaje
                     </label>
                     <div className="relative">
                       <textarea 
                         rows={5} 
